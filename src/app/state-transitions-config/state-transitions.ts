...
export const EvenTransitionsHelper = {
    onload: {
        process: function (appEventModel: AppEventModel, appDataStore: AppDataStoreService): AppEventModel {
            if (appEventModel.appState === AppState.UNKNOWN) {
                //TODO: check whether the user is signed in
                //TODO: check whether the user has th required ROLE to access this view
    ...
    products: {
        process: function (appEventModel: AppEventModel, appDataStore: AppDataStoreService): AppEventModel {
            if (appEventModel.appState === AppState.HOMEVIEW) {
                                //TODO: check whether the user is signed in
                //TODO: check whether the user has the required ROLE to access this view
                //TODO: pre-fetch data if needed
